...
% skills section
\section*{Skills}
\textbf{Languages:} C\#, Java, Kotlin, SQL \\
\textbf{Frameworks:} .NET, .NET MAUI, Xamarin, ADO.NET \\
\textbf{Tools:} Azure DevOps (TFS), Firebase, AppCenter, JIRA \\
...
\vspace{-6pt}
\begin{itemize}
  \item Suite of frontend and backend applications and services, developed with .NET and .NET MAUI, designed to support factory operations and optimize process and time management.
  \item Provides a real-time API integration with an ERP system, ensuring synchronization of key business data (invoices, orders, customers, etc.).
  \item Separate applications for shop floor teams and administrative staff, enabling end-to-end tracking of ongoing work and production progress.
\end{itemize}
