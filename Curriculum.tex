...
% skills section
\section*{Skills}
\textbf{Core Languages:} C\#, Kotlin, SQL, Java \\
\textbf{Frameworks:} .NET Core, .NET MAUI/Xamarin, Entity Framework \\
\textbf{Tools:} Azure DevOps, Firebase, AppCenter, JIRA, Git \\
...
\begin{itemize}
  ...
  \item Collaborate with mid-size team on sprint planning and delivery, integrating CI/CD services to optimize deploying time and costs, and project management with agile tools from Azure DevOps Server
\end{itemize}
...
\begin{itemize}
  ...
  \item Managed the full product lifecycle of Android application, built around gamification concept for corporates
...
\vspace{-6pt}
\begin{itemize}
  \item Designed \& led development of full .NET MAUI + backend ecosystem, integrating real-time ERP synchronization (orders, invoices, customers).
  \item Created role-specific applications for shop-floor and administrative teams, enabled end-to-end production tracking and reduced process delays.
\end{itemize}
